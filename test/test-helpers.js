  ...
  return [
    {
      ...
      nickname: 'TU1',
      password:
        '$2a$14$8qrL2/5L9g6mo1A5wYtcI.QMO.o.r5Z.9uq3i9ZEd4wUDM81AbpMm',
      date_created:
...
function makeExpectedThing(
  users,
  thing,
  reviews = []
) {
  const user = users.find(
    user => user.id === thing.user_id
  );
...
function makeExpectedThingReviews(
  users,
  thingId,
  reviews
) {
...
function makeThingsFixtures() {
  ...
  const testThings = makeThingsArray(
    testUsers
  );
